...
def create_parser():
    ...
    describe_connectivity_parser.set_defaults(
        func=describe_connectivity)

    describe_secgroup_parser = subparser.add_parser(
        'describe-security-group')
    describe_secgroup_parser.add_argument('--group-id')
    describe_secgroup_parser.add_argument('--group-name')
    describe_secgroup_parser.add_argument(
        '--detailed', action='store_true')
    describe_secgroup_parser.set_defaults(
        func=describe_security_group)
